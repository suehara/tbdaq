...
int main(int argc,char **argv)
{
  try{
    ...
    //    int id = OpenUsbDevice((char *)"SK2_02"); //tb2 skiroc2a, tb1_1
  ...
  */
    ...
    thresholdScan(id,375,415,10,100,sc,"tmp2/thresholdscan_2MIP"); // trigger thresold


    //    thresholdScanMulti(id,250,340,4,100,sc,"tmp/thresholdscan_1MIP"); // trigger thresold
    //    thresholdScanMulti(id,180,230,2,100,sc,"tmp2/thresholdscan_2MIP"); // trigger thresold
