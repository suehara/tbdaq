...
int main(int argc,char **argv)
{
  ...
  */
    ...
    //slow control 77bins 
    const char *file[] ={
      //      "../skiroc2a_TDC_3.txt" //tb5 skiroc2a TDC
      //      "../skiroc2a_TDC_3.txt" //tb5 skiroc2 TDC
      "../skiroc2a_TDC_5.txt" //tb2 skiroc2 TDC
    ...
    delayScan(id,0,256,16,300,sc,"tmp/delayscan");
    ...
    //    Acquisition(id,300,"tmp/TDC_skiroc2_tb2_200ns.raw");
