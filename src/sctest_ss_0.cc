...
int main(int argc,char **argv)
{
  ...
  */
    ...
    //    thresholdScanMulti(id,250,340,4,100,sc,"thresholdscan_1MIP"); // trigger thresold
    ...
    slowShaperMulti(id,500,sc,"tmp2/slowshaper_ch0");
