...
int main(int argc,char **argv)
{
  try{
    ...
    int id = OpenUsbDevice((char *)"SK2_PCB_V1_2");
  ...
  */
    ...
    //    thresholdScan(id,250,340,10,100,sc,"tmp/thresholdscan_1MIP"); // trigger thresold
    ...
    // 5day scan
    //    thresholdScanMulti(id,360,450,40,100,sc,"tmp/thresholdscan_2MIP"); // trigger thresold
    //    delayScanfb(id,0,256,1,400,sc,"tmp/delayscan");


    //    delayScancc(id,0,256,100,100,sc,"tmp/delayscan_comensation");
