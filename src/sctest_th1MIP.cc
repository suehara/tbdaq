...
int main(int argc,char **argv)
{
  ...
  */
    ...
    const char *file[] ={
      ...
      "../skiroc2a_ADC_25.txt"  //tb2 skiroc2a allch 
      //      "../skiroc2a_tb2_ADC_23.txt"  //tb2 skiroc2a th180 6pF
    ...
    thresholdScan(id,210,300,2,300,sc,"tmp/thresholdscan_1MIP"); // trigger thresold
